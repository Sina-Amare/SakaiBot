...
TRANSLATION_AUTO_DETECT_PROMPT: Final[str] = (
    ...
    "- Persian Telegram text is often compressed, misspelled, missing spaces, or written phonetically. "
    "Infer the most likely intended wording from grammar, nearby words, conversation context, and common Persian chat usage before translating.\n"
    "- Treat one-letter insertions/deletions, swapped letters, missing half-spaces, and attached pronouns as likely typos when the sentence becomes natural Persian after correction.\n"
    "- Do NOT mechanically translate the typo itself. Translate the corrected intended meaning.\n"
    "- If multiple readings are plausible, choose the most natural conversational meaning from context. "
    "If context is too weak, use a neutral translation that does not over-commit.\n"
    "- Do not invent extra facts, objects, people, or events while correcting typos.\n\n"
    "RULES:\n"
